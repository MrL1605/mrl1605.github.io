...
var $author$project$Messages$UpdateExperience = function (a) {
	return {$: 'UpdateExperience', a: a};
};
...
var $author$project$InterstellarCanvas$displayCanvas = _Platform_outgoingPort(
	'displayCanvas',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$init = _Utils_Tuple2(
	{longForm: '0 Years, 0 months, 0 days', shortForm: '0yr 0m'},
	$author$project$InterstellarCanvas$displayCanvas(_Utils_Tuple0));
...
var $author$project$Main$update = F2(
	function (msg, _v0) {
		...
		var jobStart = $elm$time$Time$millisToPosix(1494824532442);
		var minutes = $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$modBy,
				60,
				A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Minute, $elm$time$Time$utc, jobStart, currentTime))) + ' minutes, ';
		var months = $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$modBy,
				12,
				A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Month, $elm$time$Time$utc, jobStart, currentTime)));
		var seconds = $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$modBy,
				60,
				A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Second, $elm$time$Time$utc, jobStart, currentTime))) + 'seconds';
		var years = $elm$core$String$fromInt(
			A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Year, $elm$time$Time$utc, jobStart, currentTime));
		var shortForm = years + (' years, ' + (months + ' months'));
		var hours = $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$modBy,
				24,
				A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Hour, $elm$time$Time$utc, jobStart, currentTime))) + ' hours, ';
		var days = $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$modBy,
				365,
				A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Day, $elm$time$Time$utc, jobStart, currentTime))) + ' days, ';
		var longForm = years + (' years, ' + (months + (' months,' + (days + (hours + (minutes + seconds))))));
		return _Utils_Tuple2(
...
var $author$project$View$bodyView = F2(
	function (shortForm, longForm) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('starFieldCanvas')
									]),
								_List_Nil),
								A3(
								$elm$html$Html$node,
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('shootingStarCanvas')
									]),
								_List_Nil),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('head-content')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('name-heading')
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text('Lalit Umbarkar')
																	]))
															]))
													])),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('heading-subtext')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('I make random things, using random languages')
													])),
												A2(
												$elm$html$Html$div,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('social-ico-root lazyload')
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																...
																$elm$html$Html$Attributes$href('https://twitter.com/LalitUmbarkar'),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$alt('Twitter Logo'),
																		$elm$html$Html$Attributes$src('/assets/img/Twitter_Logo_Gray.png')
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('icon icon-linkedin-squared'),
																$elm$html$Html$Attributes$href('https://www.linkedin.com/in/mrl1605/'),
																$elm$html$Html$Attributes$rel('noopener'),
																$elm$html$Html$Attributes$target('_blank'),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$alt('LinkedIn Logo'),
																		$elm$html$Html$Attributes$src('/assets/img/LI-In-Bug-Gray.png')
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('icon icon-instagram'),
																$elm$html$Html$Attributes$href('https://instagram.com/lalitumbarkar'),
																$elm$html$Html$Attributes$rel('noopener'),
																$elm$html$Html$Attributes$target('_blank'),
																$elm$html$Html$Attributes$title('Instagram')
															]),
														_List_fromArray(
															[
																A2(
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$alt('Instagram Logo'),
																		$elm$html$Html$Attributes$src('/assets/img/Insta-logo-Gray.png')
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('icon icon-github-circled'),
																$elm$html$Html$Attributes$href('https://github.com/MrL1605'),
																$elm$html$Html$Attributes$rel('noopener'),
																$elm$html$Html$Attributes$target('_blank'),
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		$elm$html$Html$Attributes$src('/assets/img/GitHub-Mark-Gray.png')
																	]),
																_List_Nil)
															]))
													]))
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('about-heading')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('I have ')
											])),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$id('exp'),
												$elm$html$Html$Attributes$title(longForm)
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(shortForm)
											])),
										A2(
										$elm$html$Html$span,
										_List_Nil,
										_List_fromArray(
											[
												$elm$html$Html$text(' of experience as Software developer.')
											]))
									])),
								A2(
								$elm$html$Html$h5,
...
var $author$project$Main$view = function (model) {
	return {
		body: A2($author$project$View$bodyView, model.shortForm, model.longForm),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{
		...
		subscriptions: function (_v1) {
			return A2($elm$time$Time$every, 1000, $author$project$Messages$UpdateExperience);
		},
